...
import { sequelize, initializeDatabase, stopConnectionCheck } from './config/database';  // ✅ ACTUALIZADO
import { compressionMiddleware, cacheControl } from './middleware/compression.middleware';  // ✅ NUEVO
