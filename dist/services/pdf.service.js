"use strict";
// ============================================
// PDF SERVICE - SOLO PARA BACKEND (NODE.JS)
...
class PdfService {
    ...
    generarAlbaranBuffer(pedido, lineas, usuario) {
        return new Promise((resolve, reject) => {
            try {
                ...
                lineas.forEach((linea) => {
                    ...
                    const precioRaw = linea.precio !== undefined ? linea.precio : (_a = linea.product) === null || _a === void 0 ? void 0 : _a.precio;
